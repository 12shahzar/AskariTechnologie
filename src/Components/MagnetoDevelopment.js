         ...
         <div className="row p-2">
            <div className="col-lg-6 side-heading-para-content">
              ...
              <p className="main-hero-para-main-div">
                ...
                reflects your brand identity and drives financial results. Save
                up to 40% on development, maintenance, and support costs with
                our Adobe Commerce development services aka Magento development
                services
              </p>
        ...
        <div className="contianer p-5">
         <div className="row p-2">
            ...
            <p className="main-services-para-main-card-top py-3">
              We offer all-inclusive Shopify services that help  <br></br> add more
              functionality, monitor performance, <br></br> improve sales channels &
