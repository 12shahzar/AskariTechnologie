          ...
          <div className="row p-5">
            <div className="col-lg-6">
              ...
              <p className="main-908">
                ...
                feature-rich, scalable applications using MVC architecture. Get
                the most out of the development cycle, enterprise-level
                solution, and cost by partnering with our PHP Laravel experts.
              </p>
              <button className="firt-main-btn">Hire Laravel Developer</button>
            </div>
            <div className="col-lg-6">
