      ...
      <section className="hero ">
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            <h1 className="main-heading">Salesforce Implementation Services</h1>
            <p className="main-heading">
              ...
              integration, post-launch support, etc., at half the actual cost of
