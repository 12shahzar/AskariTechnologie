         ...
         <div className="row p-2">
            <div className="col-lg-6 side-heading-para-content">
              ...
              <p className="main-hero-para-main-div">
                Transform your learning experience with our custom LMS
                development services. Our LMS developers formulate effective
                strategies to meet your business needs with intuitive LMS apps.
              </p>
