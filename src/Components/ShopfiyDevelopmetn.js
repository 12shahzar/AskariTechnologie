         ...
         <div className="row p-2">
            <div className="col-lg-6 side-heading-para-content">
              ...
              <p className="main-hero-para-main-div">
                ...
                across the globe with our custom Shopify development services.
                Our Shopify eCommerce development services empower you to rival
                eCommerce giants across the world by ensuring enhanced growth
                and success for your startup, SME, enterprise, etc.
              </p>
        ...
        <div className="container p-5 py-5">
         <div className="row p-2">
            ...
            <p className="arrival-main-bottom-top-head">
              We offer all-inclusive Shopify services that help add more
              functionality, monitor performance, improve sales channels & <br />
            ...
            <button className="btn-car-arrivals-main-23">Get Started With Shopify Development</button>
          </div>
        </div>
      </section>
