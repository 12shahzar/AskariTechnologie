...
import MainFirst from "../Assets/Pythone1.png";
import mainAbout from "../Assets/pythone2.png";
        ...
        <div className="container maind-v- p-5">
         <div className="row p-2">
            <div className="col-lg-6">
              <h2 className="main9080">Hire Python Developers</h2>
              <p className="main-908">
                ...
                developers from us with 5+ years of experience in developing web
                apps with Django, Odoo framework and Python scripting.
              </p>
            ...
            <div className="col-lg-6">
              <img src={MainFirst} alt="" className="img-fluid pythone-pne" />
            </div>
          </div>
        </div>
      </section>
