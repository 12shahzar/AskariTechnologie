...
import MainFirst from "../Assets/Fabrics1.png";
import mainAbout from "../Assets/Fabrics2.png";
        ...
        <div className="container maind-v- p-5">
          <div className="row p-5">
            <div className="col-lg-6">
              <h2 className="main9080">Hire FabricJS Developers</h2>
            ...
            <div className="col-lg-6">
              <img
                src={MainFirst}
                alt=""
                className="img-fluid first-main-img"
              />
            </div>
          </div>
        </div>
