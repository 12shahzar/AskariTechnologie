          ...
          <div className="container py-5">
            ...
            <div className="row">
              <div className="col-lg-6">
                <h1 className="Brand-Name p-3">Hire .NET Developers</h1>
                <p className="Brand-slogen p-3">
                  ...
                  developers with hands-on experience in VB.Net, C#, MS SQL,
                  .Net Core, .Net MVC, ASP.NET, etc., along with various
                  Microsoft tools and technologies. Leverage our industry
                  expertise and work collaboratively with us to help you solve
                  real-world problems.
                </p>
