...
import MainFirst from "../Assets/Netcore1.png";
import mainAbout from "../Assets/Netcore2.png";
        ...
        <div className="container maind-v- p-5">
         <div className="row p-2">
            <div className="col-lg-6">
              <h2 className="main9080">Hire .NET Developers</h2>
              <p className="main-908">
                Our expert team of .Net core developers can create intuitive,
                robust, scalable, and complete end-to-end solutions. Hire .NET
                developers with hands-on experience in VB.Net, C#, MS SQL, .Net
                Core, .Net MVC, ASP.NET, etc., along with various Microsoft
                tools and technologies. Leverage our industry expertise and work
                collaboratively with us to help you solve real-world problems.
              </p>
            ...
            <div className="col-lg-6">
              <img src={MainFirst} alt="" className="img-fluid NET_CORE" />
            </div>
          </div>
        </div>
      </section>
