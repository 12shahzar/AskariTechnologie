...
import MainFirst from "../Assets/Nodejs1.png";
import mainAbout from "../Assets/Nodejs2.png";
        ...
        <div className="container maind-v- p-5">
         <div className="row p-2">
            <div className="col-lg-6">
              <h2 className="main9080">Hire NodeJS Developer</h2>
              <p className="main-908">
                ...
                and more. Choose the best team for your next project!
              </p>
              <button className="firt-main-btn">Hire NodeJS Expert</button>
            </div>
            <div className="col-lg-6">
              <img src={MainFirst} alt="" className="img-fluid nodejs-main" />
            </div>
          </div>
        </div>
      </section>
