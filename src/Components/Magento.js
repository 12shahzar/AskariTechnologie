...
// Image Import
import MainIMG from "../Assets/MagentMain.jpg.png";
import Main2Img from "../Assets/MagentoHome.jpg.png";
const Magento = (props) => {
          ...
          <div className="container py-5">
            ...
            <div className="row">
              <div className="col-lg-6">
                <h1 className="Brand-Name p-3">Magento Development Services</h1>
        ...
        <div className="container">
          ...
          <div className="row services-row ">
            <ServcicesCard
              ...
              Para={
                "Find Shopify website developers who can handle all the responsibilities right from planning to launch. When you hire expert Shopify developers from us, you get complete control over your project,"
              }
            />
            <ServcicesCard
            ...
            <ServcicesCard
              ...
              Para={
                "From customizing a feature to developing a tailored solution for your business, Shopify developers will help you with everything. Get end-to-end support when you hire dedicated "
              }
            />
          </div>
        </div>
