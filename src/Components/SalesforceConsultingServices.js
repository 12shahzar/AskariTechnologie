...
const SalesforceConsultingServices = (props) => {
      ...
      <section className="hero ">
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            <h1 className="main-heading">Salesforce Consulting Services</h1>
        ...
        <div className="container-fluid">
          ...
          <div className="row leading-card-row py-4">
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Risk Assessment</h5>
              <p className="leading-card-para">
                Salesforce consultants take tangible actions to verify that your
                solution is risk-free and capable of handling real-time issues.
                They remove process irregularities and resolve all your business
                challenges.
              </p>
            </div>
            <div className="col-md-2 leadin-card p-5  ">
              <h5 className="leading-card-head">Industry Expertise</h5>
              <p className="leading-card-para">
                Salesforce consultants have extensive expertise with managing
                Salesforce CRM process designs, implementation and
                configurations along with other CRMs and industry specific
                requirements.
              </p>
            </div>

            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Improved Productivity</h5>
              <p className="leading-card-para">
                With Salesforce consulting services, you can take a proactive
                approach to meet the needs of changing customer relationships,
                while experts design the strategic implementation process to fit
                the business needs.
              </p>
            </div>
            <div className="col-md-2 leadin-card p-5 ">
              ...
              <p className="leading-card-para">
                By partnering with the right Salesforce consulting company, you
                can close more deals quickly. Certified Salesforce consultants
                know the ins and outs of the CRM to handle implementation and
                development processes smoothly.
              </p>
            </div>

            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Security And Support</h5>
              <p className="leading-card-para">
                Salesforce consultants help you get comprehensive protection for
                all your business data, starting from migration and backups to
                modern security standards and regular version updates.
              </p>
            </div>

            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Better ROI</h5>
              <p className="leading-card-para">
                Salesforce consultants are CRM experts and can assist you to
                make better decisions about business growth and operations.
                Investing in the best Salesforce consulting companies in USA
