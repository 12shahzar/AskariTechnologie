...
import Main2Img from "../Assets/MicosoftDyanmic1.png";
...
import Banner from "../Assets/micorsoft.png";

const MicrosoftDynamic = (props) => {
      ...
      <section className="leading py-5">
        <div className="container-fluid">
          ...
          <p className="leading-para">
            Biztech offers a host of opportunities to create exceptional
            experiences. We have vast experience in Microsoft Dynamics CRM
            development that includes top-class features and functionalities.
          </p>
          <div className="row leading-card-row py-4">
            ...
            <div className="col-md-2 leadin-card p-5  ">
              <h5 className="leading-card-head">Fast Resolution Time</h5>
              <p className="leading-card-para">
            ...
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Data Security</h5>
              <p className="leading-card-para">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 box2">
            <h1 className="support-head">
              Why Askari Tech for Microsoft Dynamics Development
            </h1>
...
export default MicrosoftDynamic;
