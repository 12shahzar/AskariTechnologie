...
// Image Import
import MainIMG from "../Assets/flutter 1.png";
import Main2Img from "../Assets/flutterImg2.png";
/// DEv 2 File Import
          ...
          <div className="container py-5">
            ...
            <div className="row">
              <div className="col-lg-6">
                <h1 className="Brand-Name p-3">Hire Flutter Developer</h1>
                <p className="Brand-slogen p-3">
                  Our certified Flutter developers create stunning
                  cross-platform applications that you can manage with a single
                  database. Equipped with extensive experience of Dart, RESTFUL
                  APIs, SQLLite, SOLID principles, and other framework-specific
                  libraries and tools, our experts cater to all your flutter
                  development needs.
                </p>
                <button className="Hire-btn">Hire Flutter Developer</button>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 m-auto ">
            <h3 className="about-head p-3">
              HHire Dedicated Flutter Developers to Unleash Your Brand Potential
            </h3>
            <p className="about-para p-3 ">
              Biztech’s Flutter developers come with years of hands-on
              experience working on Flutter projects of all shapes and sizes.
              From conceptualization to planning and implementation, we provide
              comprehensive solutions for each step as the development cycle
              rolls on. Our customer-centric approach ensures that we not only
              meet your expectations but also exceed them. Whether it’s
              utilizing Flutter libraries and widgets to create intuitive
              interfaces or leveraging AI and ML to create business logic, our
              Flutter app developers know it all!
            </p>
          </div>
        </div>
      </section>
