...
// Image Import
import MainIMG from "../Assets/technology_logo_bg 1.png";
import Main2Img from "../Assets/Technology2.png";
          ...
          <div className="container py-5">
            ...
            <div className="row">
              <div className="col-lg-6">
                <h1 className="Brand-Name p-3">Hire FabricJS Developers</h1>
                <p className="Brand-slogen p-3">
                  Plug into the pool of talent and work with top FabricJS
                  developers risk-free. Hire vetted, proven, FabricJS developers
                  to customize your web and app interface with animations and
                  effects on text, images, and various shapes.
                </p>
                <button className="Hire-btn">
                  Hire FabricJS Developer Now
                </button>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 m-auto ">
            <h3 className="about-head p-3">
              Create Engaging Visuals with FabricJS Experts
            </h3>
            <p className="about-para p-3 ">
              Our team has vast experience in working with modern technologies
              like AngularJS, ReactJS, NodeJS, etc. Hire vetted FabricJS
              developers from Biztechcs to ensure the highest standard of
              quality and competitiveness! We have a pool of talented resources,
              including designers, developers, marketers, and business analysts,
              on hand to deliver top-notch services. Our team is skilled at
              creating excellent user interfaces and customizing elements and
              effects to enhance user experience. Their ability to understand
              business requirements and turn them into reliable technical
              solutions can take your business to the next level. Hiring top
              personnel for your interface development project guarantees
              high-quality results on schedule. Our dedicated Fabric JS
              developers will walk you through every step of the development
              process. You can count on us for assistance and maintenance even
              after completing your project. Let’s build great solutions
              together!
            </p>
          </div>
        </div>
          ...
          <div className="row  ">
            <div className="col-lg-6 conact-c1">
              ...
              <p className="contact-para">
                Ready to Hire FabricJS Programmers?
              </p>
            </div>
