...
const SalesFroceApllication = (props) => {
  return (
    <>
        ...
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            ...
            <p className="main-heading">
              From employee engagement to customer experiences, get the most out
              of Salesforce CRM with our custom Salesforce App Development
              services. Build scalable apps with out-of-box security,
              governance, and performance with a Salesforce ISV partner at your
              disposal.
            </p>
      ...
      <section className="serveices py-5">
        <div className="container py-5">
          <div className="col-lg-6">
            <h3 className="ser-head">Salesforce Implementation Services</h3>
            <p className="ser-para">
              Scale your digital transformation with our end-to-end Salesforce
              development services that provide highly intuitive Salesforce
              solutions for a compelling user experience.
            </p>
          </div>
          <div className="row services-column">
            <div className="col-md-2 ser-card p-3 ">
              <h4 className="card-heade">Sales Cloud Implementation</h4>
              <p>
                Increase sales, improve customer communication, and gain
                valuable insights into pipelining and forecasting, all on the
                same platform with our Salesforce sales cloud implementation
                services.
              </p>
            </div>

            <div className="col-md-2 ser-card p-3">
              <h4 className="card-heade">Service Cloud Implementation</h4>
              <p>
                Boost customer loyalty with streamlined workflows and
                personalized services across every touchpoint. Hire our
                Salesforce service cloud implementation consultants and get an
                inside scoop into every customer interaction..
              </p>
            </div>

            <div className="col-md-2 ser-card p-3">
              <h4 className="card-heade">Community Cloud Implementation</h4>
              <p>
                Build next-gen communities and customize them with Salesforce
                community cloud implementation to reflect the brand. Deliver
                real-time experience to your customers, partners, and employees.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row leading-card-row py-4">
            <div className="col-md-2 leadin-card p-5 ">
              ...
              <p className="leading-card-para">
                With Salesforce implementation, you can keep all your customers'
                data well organized in one place. You won’t have to worry about
                data scattered over different departments.
              </p>
            </div>
            <div className="col-md-2 leadin-card p-5  ">
            ...
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Customer-Centric Approach</h5>
              <p className="leading-card-para">
                You can organize and present customer information in a
                user-friendly manner. This way, you can manage the sales
                processes effectively.
              </p>
            </div>

            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Modernized Infrastructure</h5>
              <p className="leading-card-para">
                Salesforce implementation helps your business modernize
                infrastructure by implementing the latest technologies and
                extracting the best out of customer data. It helps you make
                informed decisions.
              </p>
            </div>
...
export default SalesFroceApllication;
