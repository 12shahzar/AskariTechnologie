...
// Image Import
import MainIMG from "../Assets/Salesforce-Mobile-App-Development 1.png";
import Main2Img from "../Assets/salesforce.png";
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="Brand-slogen p-3">
                  ...
                  developers. Hire Salesforce developers from us and leverage
                  the benefit of digital transformation to meet emerging
                  customer demands. Have a specific requirement? Relax! We’ve
                  got you covered.
                </p>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 m-auto ">
            <h3 className="about-head p-3">
              Achieve Breakthrough Results with Dedicated Salesforce Developers
            </h3>
            <p className="about-para p-3 ">
              Hire a team of Salesforce specialists at flexible pricing to
              launch customer-centric campaigns, assess customer interests for
              product improvements, and fully leverage the potential of
              Salesforce CRM. Besides being a Salesforce ISV partner, we have
              vivid experience in development, implementation, third-party
              integration, customization, and cloud solutions. Our Salesforce
              programmers have assisted companies across various sectors in
              streamlining direct marketing, customer information management,
              and database management with successful Salesforce CRM
              implementation. Our programmers are well-versed in Salesforce
              Cloud, Lightning components, Visualforce, Apex code, Heroku,
              Pardot, and REST/SOAP APIs. Hire Salesforce developers from us to
              get the best CRM solution for your business.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-fluid">
          <div className="row  ">
            <div className="col-lg-6 conact-c1">
              <h3 className="contact-head mt-5">Our Expertise</h3>
        ...
        <div className="container">
          ...
          <div className="row services-row ">
            <ServcicesCard
              ...
              Para={
                "Certified Salesforce developers take concrete steps to ensure that all apps built on the platform are risk-free and capable of addressing real-time task execution flaws. They avoid any inconsistencies in the processes"
              }
            />
            <ServcicesCard
