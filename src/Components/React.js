...
import MainFirst from "../Assets/React1.png";
import mainAbout from "../Assets/React2.png";
        ...
        <div className="container maind-v- p-5">
         <div className="row p-2">
            <div className="col-lg-6">
              <h2 className="main9080">Hire ReactJS Developer </h2>
              <p className="main-908">
                ...
                skills and competence at an unbeatable price with Askari . Our
                React JS developers have mastered the skill of dealing with the
                ultimate JavaScript library, Git toolkit, ElectronJS, npm-audit
                and other React stack for front-end development. Ready to
            ...
            <div className="col-lg-6">
              <img src={MainFirst} alt="" className="img-fluid react-js-img" />
            </div>
          </div>
        </div>
      </section>
