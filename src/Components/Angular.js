...
// Image Import
import MainIMG from "../Assets/angular1.jpg";
import Main2Img from "../Assets/Angular2.png";
/// DEv 2 File Import
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="Brand-slogen p-3">
                  Gather AngularJS developers who can find the best way to use
                  the JavaScript framework for your project. Hire AngularJS
                  developers from us to get the most of the latest technologies
