      ...
      <section className="hero ">
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            <h1 className="main-heading">Custom LMS Development Services</h1>
            <p className="main-heading">
              Transform your learning experience with our custom LMS development
              services. Our LMS developers formulate effective strategies to
              meet your business needs with intuitive LMS apps.
            </p>
        ...
        <div className="container-fluid">
          <div className="row py-5">
            <div className="col-lg-6 py-5 contact-cc1">
              ...
              <p className="c-para">
                Share your business requirements and book a 30-minute free
          ...
          <div className="row leading-card-row py-4">
            <div className="col-md-2 leadin-card p-5 ">
              ...
              <p className="leading-card-para">
                We offer round-the-clock Salesforce CRM support to ensure the
                utmost performance of your Salesforce system, irrespective of
                the complexity, location, or time.
              </p>
            </div>
            <div className="col-md-2 leadin-card p-5  ">
              <h5 className="leading-card-head">Data Management</h5>
              <p className="leading-card-para">
                We adhere to all the data management standards and best
                practices like uploads, cleansing, validation, and setups to
                minimize the risk of data errors.
              </p>
            </div>

            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Help Desk To Troubleshoot</h5>
              <p className="leading-card-para">
                No matter your query, our help desk team is there to assist you
                with all the required support, regardless of the complexity. Our
                Salesforce experts will find ways to troubleshoot your queries
                quickly.
              </p>
            </div>
            <div className="col-md-2 leadin-card p-5 ">
