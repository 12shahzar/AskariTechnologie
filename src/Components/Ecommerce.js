...
import Main2Img from "../Assets/ecommmerceCover.png";
    ...
    <>
      <section className="hero ">
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            <h1 className="main-heading">eCommerce App Development Services</h1>
            <p className="main-heading">
              ...
              apps that drive growth to your business. Expand your customer base
              with our experienced mobile app developers today.
            </p>
            <button className="btn Hire-btn p-2">Start 15-Day Free MVP</button>
          </div>
        </div>
      </section>
      ...
      <section className="leading py-5">
        <div className="container-fluid">
          <h2 className="leading-head">
            eCommerce App Development Services by Askari Technologie
          </h2>
          ...
          <div className="row leading-card-row py-4">
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">eCommerceApp Consultation</h5>
            ...
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">
                eCommerceMobile App Development
              </h5>
              <p className="leading-card-para">
            ...
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">Enhance Appwith AR VR</h5>
              <p className="leading-card-para">
          ...
          <div className="row leading-card-row py-4">
            ...
            <div className="col-md-2 leadin-card p-5 ">
              <h5 className="leading-card-head">SecurityUpdates</h5>
              <p className="leading-card-para">
                Develop native-like apps and mobile responsive websites with our
                Magento PWA development services. You can leverage our Magento
                PWA development to help your business support mobile
      ...
      <section className="packages ">
        <div className="container">
          ...
          <div className="row pakeges-card ">
            <div className="col-lg-4 offer-card m-auto ">
              <div className="offer-content text-center">
                <p className="offer">Free</p>
                <h3 className="pakages-price">$0</h3>
                <p className="pakage-description">Per month, billed anually</p>
                <button className="pakage-btn btn">Try It For Free </button>
              </div>
              <ul className="offer-ul py-3">
                <li>
                  <i class="bi bi-check-lg"> </i> Complete Documentation
                </li>
                <li>
                  <i class="bi bi-check-lg"> </i> Working Materials in Figma
                </li>
                <li>
                  <i class="bi bi-check-lg"> </i> 100GB Cloud Storage
                </li>
                <li>
                  <i class="bi bi-check-lg"> </i> Email Automation
                </li>
                <li>
                  <i class="bi bi-check-lg"> </i> Premium Support
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-4 offer-card m-auto">
              <div className="offer-content text-center">
                <p className="offer">Pro</p>
                <h3 className="pakages-price">$49</h3>
                <p className="pakage-description">Per month, billed anually</p>
                <button className="pakage-btn btn btn-color">
                  Try It For Free{" "}
                </button>
              </div>
              <ul className="offer-ul py-3">
            ...
            <div className="col-lg-4 offer-card m-auto">
              <div className="offer-content text-center">
                <p className="offer">Exclusive</p>
                <h3 className="pakages-price">$99</h3>
                <p className="pakage-description">Per month, billed anually</p>
                <button className="pakage-btn btn ">Try It For Free </button>
              </div>
              <ul className="offer-ul py-3">
