...
// Image Import
import MainIMG from "../Assets/the-developer-resets-designs-discusses-and-makes-applications-illustration-free-vector 1.png";
          ...
          <div className="container-fluid py-5">
            ...
            <div className="row">
              <div className="col-lg-6">
                <h1 className="Brand-Name p-3">Hire Android App Developers</h1>
                <p className="Brand-slogen p-3">
                  ...
                  multi-technology projects. Gain control over 85 percent of the
                  global market with the right talent.
                </p>
                <button className="btn Hire-btn">Hire Android Developer</button>
              </div>
              <div className="col-lg-6 ">
                <img
                  src={MainIMG}
