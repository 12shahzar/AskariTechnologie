      ...
      <section className="hero ">
        <div className="container-fluid">
          ...
          <div className="col-lg-5">
            <h1 className="main-heading">Leverage Odoo Development Services</h1>
            <p className="main-heading">
              ...
              best practices, technical knowledge, and valuable insights, we can
              help you achieve your business success. Avail of Odoo development
              services from BiztechCS to let a team of Odoo Ready partners help
              with your business app management.
            </p>
            <button className="btn Hire-btn p-2">Get A Free Quote</button>
          </div>
        </div>
      </section>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 box2">
            <h1 className="support-head">
              Why Choose Biztech for Odoo ERP Development
            </h1>
            <p className="support-para">
              We help you with a highly flexible ERP solution to manage all your
              business processes. You can rely on us for consultation, design,
              development, implementation, and post-launch support. Our team
              will help you find the ERP problems you may face.
            </p>
